...
int main(){
	...
	unsigned int vetor[200]; //vetor para guardar valores inteiros de 1 a 5000
	...
	while (y != -1){ //ao digitar -1 as operacoes se encerram
		...
		if (y >= 0 && y <= 5000){ //se o valor digitado estiver entre 0 e 5000
			vetor[y/32] = vetor[y/32] | (2147483648 >> (y%32)); //acionar o bit na posicao do numero que foi digitado
